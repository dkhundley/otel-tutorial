...
from stream_otel_config import configure_otel
from stream_pizza_helpers import *
...
MENU_PATH = Path(__file__).with_name('stream_pizza_menu.json')
PIZZA_MENU = json.loads(MENU_PATH.read_text(encoding='utf-8'))
...
async def create_pizza_order(payload: PizzaOrderRequest):
    ...
    with tracer.start_as_current_span('create_pizza_order') as span:
        ...
        # Estimating the prep time, bake time, and total time
